...
public class CustomIntegerArrayStreamSearchServiceImpl implements CustomIntegerArraySearchService {

    private static final Logger logger = LogManager.getLogger();
    private static final CustomIntegerArrayStreamSearchServiceImpl instance =
            new CustomIntegerArrayStreamSearchServiceImpl();

    private CustomIntegerArrayStreamSearchServiceImpl() {
    }

    public static CustomIntegerArrayStreamSearchServiceImpl getInstance() {
        return instance;
    }
