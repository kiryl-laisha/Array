...
public class NegativeElementQuantityEqualsValueSpecificationImpl
    ...
    public NegativeElementQuantityEqualsValueSpecificationImpl(int providedValue) {
    ...
    public boolean specify(UserIntegerArray userIntegerArray) {
        ...
        return (integerArrayStatistics.getNegativeElementQuantity() == providedValue);
    }
}
