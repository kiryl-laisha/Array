...
public class MaxElementEqualsValueSpecificationImpl implements IntegerArraySpecification {

    private static final Warehouse warehouse = Warehouse.getInstance();
    private final int providedValue;

    public MaxElementEqualsValueSpecificationImpl(int providedValue) {
