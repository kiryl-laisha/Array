...
public class TotalSumEqualsValueSpecificationImpl implements IntegerArraySpecification {

    private static final Warehouse warehouse = Warehouse.getInstance();
    private final long providedValue;

    public TotalSumEqualsValueSpecificationImpl(long providedValue) {
    ...
    public boolean specify(UserIntegerArray userIntegerArray) {
        ...
        return (integerArrayStatistics.getTotalSum() == providedValue);
    }
}
