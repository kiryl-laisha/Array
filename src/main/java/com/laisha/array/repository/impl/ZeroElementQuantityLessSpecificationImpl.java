...
public class ZeroElementQuantityLessSpecificationImpl implements CustomArraySpecification {
    ...
    public ZeroElementQuantityLessSpecificationImpl(int providedValue) {
